...
public class Ballot9 
{ 
  public static void main (String args[]) throws InterruptedException
  {
    if (args.length < 1) 
    {
        System.err.println ( "Usage: java Ballot9 image_file_name");
        System.exit(1);
    }
...
// }
    ...
    if (((topright.x - topleft.x) < 1100  /*660*/) || 
        ((topright.x - topleft.x) > 1200  /*750*/) ||
    ...
    */
    ...
    final double [] baroff = new double [] {0.64, 1.00};  // {1.04, 1.54};    // barcode 
    final int bcodeWidth = 24;
    final int bcodeHeight = 64;
