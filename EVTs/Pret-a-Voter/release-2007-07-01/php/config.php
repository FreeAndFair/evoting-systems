...
$db_databasename = "pretavoter";//"pav4";	// name of db on server
...
$race_titles = array('What is your favourite parasite?','What is your favourite programming language?','Have you ever lied on an expenses form?');
$races_candidates= array();

/** TODO: Set up the following values to be the names of the candidates in canonical order */
$races_candidates[0] = array("Head Louse","Leech","Liver Fluke","Paris Hilton","Tapeworm");
$races_candidates[1] = array("C++","Java","Hand-coded Z80 assembler","I make my PhD student do all my programming","Perl","Python");
