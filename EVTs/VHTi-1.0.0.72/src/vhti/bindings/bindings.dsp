...
!MESSAGE 
!MESSAGE "bindings - Win32 Release" (based on "Win32 (x86) Generic Project")
!MESSAGE "bindings - Win32 Debug" (based on "Win32 (x86) Generic Project")
!MESSAGE 
...
# Begin Custom Build
ProjDir=.
InputPath=.\mkinterface.pl

"$(ProjDir)/invisibleman.txt" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	perl $(ProjDir)/mkinterface.pl -c mki/gen_all.cfg
