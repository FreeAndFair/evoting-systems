                ...
                <td width="3%" align="left" height="380"><img src="images/blueline_3.gif" width="1" height="380"></td>
                 ...
                 <br>                   
                   <table width="100%" height="100%">
                 	 <tr valign="top">
                 	   <td>
                 	     Het bestand is ter verwerking aan het systeem aangeboden. Op het scheduler overzicht is de voortgang te zien. Klik <a href="ScheduledJobsOverview">hier</a> om het scheduler overzicht te tonen.
                 	   </td>
                 	 </tr>
                 	 <tr>
                 	   <td align="right">
