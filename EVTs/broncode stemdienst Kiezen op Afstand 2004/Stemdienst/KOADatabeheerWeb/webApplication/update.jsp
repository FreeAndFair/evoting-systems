            ...
            <tr valign="top">
                ...
                <td width="94%" valign="top" height="360">
				    ...
				    <TBODY>
    				    ...
    				    <TR>
            				<TD>Locatie van het aanvullende kiezersbestand</TD>
        				...
        				<TR>
                          ...
                          <TD align="right">
                            <input type="submit" name="verwerk_lijst" value="Verwerk lijst" width="108" height="46" border="0" alt="druk op verder om het aanvullende kiezersbestand te valideren">
                          </TD>
        				</TR>
    				</TBODY>
					</TABLE>
