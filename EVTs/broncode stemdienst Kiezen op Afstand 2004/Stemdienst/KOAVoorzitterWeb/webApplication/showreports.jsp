...
<%
	com.logicacmg.koa.voorzitter.command.ShowReportsCommand xCommand = (ShowReportsCommand) request.getAttribute(CommandConstants.COMMAND_IN_REQUEST_KEY);
...
<TITLE>Kiezen op afstand - Voorzitter - Toon rapporten</TITLE>
      ...
      <table width="725" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr valign="top">
                ...
                <table width="100%" height="100%">
                	<tr><td>Op deze pagina kan het stembureau rapporten opvragen.</td></tr>
                	<tr><td>De huidige systeemstatus is: <b><%= sDutchCurrentState %></b></td></tr>
                	<tr><td>Maak een keuze uit een van de onderstaande opties:</td></tr>
                	<tr>
                	  <td valign="top">
                		<ul>
