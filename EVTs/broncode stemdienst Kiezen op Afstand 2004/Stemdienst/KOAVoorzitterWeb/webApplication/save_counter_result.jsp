<%@page import="com.logicacmg.koa.voorzitter.command.*,com.logicacmg.koa.dataobjects.*" %>
...
<TITLE>Kiezen op afstand - Voorzitter - Hoofdpagina</TITLE>
        ...
        <table width="725" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr valign="top">
                ...
                <table width="100%" height="100%">
                	<tr valign="top">
                	  <td align="left">
                	    De tellerstanden zijn opgeslagen.
                	  </td>
                	</tr>
                   	<tr>
                		<TD align="right">&nbsp;</TD>
