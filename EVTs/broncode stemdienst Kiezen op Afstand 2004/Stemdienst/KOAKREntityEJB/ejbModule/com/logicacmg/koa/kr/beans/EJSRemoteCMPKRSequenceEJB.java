...
public class EJSRemoteCMPKRSequenceEJB extends EJSWrapper implements KRSequenceEJB {
	...
	public java.math.BigDecimal getNextID() throws java.rmi.RemoteException {
		...
		try {
			com.logicacmg.koa.kr.beans.KRSequenceEJBBean beanRef = (com.logicacmg.koa.kr.beans.KRSequenceEJBBean)container.preInvoke(this, 0, _EJS_s);
	...
	public void setNextID(java.math.BigDecimal newNextID) throws java.rmi.RemoteException {
		...
		try {
			com.logicacmg.koa.kr.beans.KRSequenceEJBBean beanRef = (com.logicacmg.koa.kr.beans.KRSequenceEJBBean)container.preInvoke(this, 1, _EJS_s);
