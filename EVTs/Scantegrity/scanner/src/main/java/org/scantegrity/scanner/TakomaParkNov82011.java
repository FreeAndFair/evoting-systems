 ...
 *
 */
public class TakomaParkNov82011
{
	...
	public static void main(String[] args)
	{
		...
		//Dimension l_d = new Dimension(2550, 4200); Difference: 450
		Dimension l_d = new Dimension(2550, 3750);
		Point[] l_marks = new Point[2];
		l_marks[0] = new Point(462, 1266);
		l_marks[1] = new Point(462, 3208);
		
		QRCodeReader l_code = new QRCodeReader();
		l_code.setSerialBoundingBox(new Rectangle(900, 3078, 504, 504));
		...
		l_rects.get(0).elementAt(0).add(new Rectangle(1260, 1604, 166, 64));
		l_rects.get(0).elementAt(0).add(new Rectangle(1454, 1604, 166, 64));
		l_rects.get(0).add(new Vector<Rectangle>());
		l_rects.get(0).elementAt(1).add(new Rectangle(1260, 1752, 166, 64));
		l_rects.get(0).elementAt(1).add(new Rectangle(1454, 1752, 166, 64));
		...
		l_tempMap.put(1, (new Rectangle(260, 1723, 990, 183)));
		...
		l_rects.get(1).elementAt(0).add(new Rectangle(1260, 2239, 166, 64));
		l_rects.get(1).elementAt(0).add(new Rectangle(1454, 2239, 166, 64));
		l_rects.get(1).add(new Vector<Rectangle>());
		l_rects.get(1).elementAt(1).add(new Rectangle(1260, 2385, 166, 64));
		l_rects.get(1).elementAt(1).add(new Rectangle(1454, 2385, 166, 64));
		l_tempMap = new TreeMap<Integer, Rectangle>();
		l_tempMap.put(1, (new Rectangle(260, 2352, 990, 192)));
		...
		l_rects.get(2).elementAt(0).add(new Rectangle(1260, 2239, 166, 64));
		l_rects.get(2).elementAt(0).add(new Rectangle(1454, 2239, 166, 64));
		l_rects.get(2).elementAt(0).add(new Rectangle(1642, 2239, 166, 64));
		l_rects.get(2).add(new Vector<Rectangle>());
		l_rects.get(2).elementAt(1).add(new Rectangle(1260, 2385, 166, 64));
		l_rects.get(2).elementAt(1).add(new Rectangle(1454, 2385, 166, 64));
		l_rects.get(2).elementAt(1).add(new Rectangle(1642, 2385, 166, 64));
		l_rects.get(2).add(new Vector<Rectangle>());
		l_rects.get(2).elementAt(2).add(new Rectangle(1260, 2521, 166, 64));
		l_rects.get(2).elementAt(2).add(new Rectangle(1454, 2521, 166, 64));
		l_rects.get(2).elementAt(2).add(new Rectangle(1642, 2521, 166, 64));
		l_tempMap = new TreeMap<Integer, Rectangle>();
		l_tempMap.put(2, (new Rectangle(260, 2500, 990, 192)));
		...
		l_rects.get(3).elementAt(0).add(new Rectangle(1260, 2235, 166, 64));
		l_rects.get(3).elementAt(0).add(new Rectangle(1454, 2235, 166, 64));
		l_rects.get(3).elementAt(0).add(new Rectangle(1642, 2235, 166, 64));
		l_rects.get(3).elementAt(0).add(new Rectangle(1839, 2235, 166, 64));
		l_rects.get(3).add(new Vector<Rectangle>());
		l_rects.get(3).elementAt(1).add(new Rectangle(1260, 2380, 166, 64));
		l_rects.get(3).elementAt(1).add(new Rectangle(1454, 2380, 166, 64));
		l_rects.get(3).elementAt(1).add(new Rectangle(1642, 2380, 166, 64));
		l_rects.get(3).elementAt(1).add(new Rectangle(1839, 2380, 166, 64));
		l_rects.get(3).add(new Vector<Rectangle>());
		l_rects.get(3).elementAt(2).add(new Rectangle(1260, 2521, 166, 64));
		l_rects.get(3).elementAt(2).add(new Rectangle(1454, 2521, 166, 64));
		l_rects.get(3).elementAt(2).add(new Rectangle(1642, 2521, 166, 64));
		l_rects.get(3).elementAt(2).add(new Rectangle(1839, 2521, 166, 64));
		l_rects.get(3).add(new Vector<Rectangle>());
		l_rects.get(3).elementAt(3).add(new Rectangle(1260, 2663, 166, 64));
		l_rects.get(3).elementAt(3).add(new Rectangle(1454, 2663, 166, 64));
		l_rects.get(3).elementAt(3).add(new Rectangle(1642, 2663, 166, 64));
		l_rects.get(3).elementAt(3).add(new Rectangle(1839, 2663, 166, 64));
		l_tempMap = new TreeMap<Integer, Rectangle>();
		l_tempMap.put(3, (new Rectangle(260, 2630, 990, 192)));
		...
		l_rects.get(4).elementAt(0).add(new Rectangle(1260, 2239, 166, 64));
		l_rects.get(4).elementAt(0).add(new Rectangle(1454, 2239, 166, 64));
		l_rects.get(4).add(new Vector<Rectangle>());
		l_rects.get(4).elementAt(1).add(new Rectangle(1260, 2385, 166, 64));
		l_rects.get(4).elementAt(1).add(new Rectangle(1454, 2385, 166, 64));
		l_tempMap = new TreeMap<Integer, Rectangle>();
		l_tempMap.put(1, (new Rectangle(260, 2352, 990, 192)));
		...
		l_rects.get(5).elementAt(0).add(new Rectangle(1260, 2239, 166, 64));
		l_rects.get(5).elementAt(0).add(new Rectangle(1454, 2239, 166, 64));
		l_rects.get(5).add(new Vector<Rectangle>());
		l_rects.get(5).elementAt(1).add(new Rectangle(1260, 2385, 166, 64));
		l_rects.get(5).elementAt(1).add(new Rectangle(1454, 2385, 166, 64));
		l_tempMap = new TreeMap<Integer, Rectangle>();
		l_tempMap.put(1, (new Rectangle(260, 2352, 990, 192)));
		...
		l_rects.get(6).elementAt(0).add(new Rectangle(1260, 2239, 166, 64));
		l_rects.get(6).elementAt(0).add(new Rectangle(1454, 2239, 166, 64));
		l_rects.get(6).elementAt(0).add(new Rectangle(1642, 2239, 166, 64));
		l_rects.get(6).add(new Vector<Rectangle>());
		l_rects.get(6).elementAt(1).add(new Rectangle(1260, 2385, 166, 64));
		l_rects.get(6).elementAt(1).add(new Rectangle(1454, 2385, 166, 64));
		l_rects.get(6).elementAt(1).add(new Rectangle(1642, 2385, 166, 64));
		l_rects.get(6).add(new Vector<Rectangle>());
		l_rects.get(6).elementAt(2).add(new Rectangle(1260, 2521, 166, 64));
		l_rects.get(6).elementAt(2).add(new Rectangle(1454, 2521, 166, 64));
		l_rects.get(6).elementAt(2).add(new Rectangle(1642, 2521, 166, 64));
		l_tempMap = new TreeMap<Integer, Rectangle>();
		l_tempMap.put(2, (new Rectangle(260, 2500, 990, 192)));
		...
		l_contestantIds.get(3).add(2);
		l_contestantIds.get(3).add(3);
		...
		l_can.add(new Contestant(0, "Seth Grimes"));
		l_can.add(new Contestant(1, "Write-In"));
		l_x.setContestants(l_can);
		l_x.setMethod(new InstantRunoffTally());
		l_c.add(l_x);		
		...
		l_can = new Vector<Contestant>();
		l_can.add(new Contestant(0, "Lorig Charkoudian"));
		l_can.add(new Contestant(1, "Tim Male"));
		...
		l_can = new Vector<Contestant>();
		l_can.add(new Contestant(0, "Kay Daniels-Cohen"));
		l_can.add(new Contestant(1, "Mike Graul"));
		l_can.add(new Contestant(2, "Jeffrey Noel-Nosbaum"));
		l_can.add(new Contestant(3, "Write-In"));
		l_x.setContestants(l_can);
		l_x.setMethod(new InstantRunoffTally());
		l_c.add(l_x);		
		...
		l_can = new Vector<Contestant>();
		l_can.add(new Contestant(0, "Terry J. Seamens"));
		l_can.add(new Contestant(1, "Write-In"));
		l_x.setContestants(l_can);
		l_x.setMethod(new InstantRunoffTally());
		l_c.add(l_x);		
		...
		l_can = new Vector<Contestant>();
		l_can.add(new Contestant(0, "Barrie Howard"));
		...
		l_config.setLocation("Takoma Park Community Center Room");
		l_config.setName("November 8, 2011 Municipal Election at Takoma Park");
		...
		l_config.setDate("Tuesday, November 8, 2011");
