 ...
 *
 */
public class TakomaParkMockOct102011
{
	...
	public static void main(String[] args)
	{
		...
		l_can.add(new Contestant(0, "Candidate 1"));
		...
		l_can = new Vector<Contestant>();
		l_can.add(new Contestant(0, "Candidate 1"));
		l_can.add(new Contestant(1, "Candidate 2"));
		...
		l_can.add(new Contestant(0, "Candidate 1"));
		l_can.add(new Contestant(1, "Candidate 2"));
		l_can.add(new Contestant(2, "Candidate 3"));
		...
		l_config.setLocation("Takoma Park Community Center Hydrangea Room");
		l_config.setName("October 10 Test Election at Takoma Park");
		...
		l_config.setDate("Monday, October 10, 2011");
