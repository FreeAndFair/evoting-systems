...
xmlns:xsl="http://www.w3.org/1999/XSL/Transform"><xsl:template match="/">
  ...
  <head>
     <script language="JavaScript1.2">
		...
		{
		  if(order !="1"+i) {	    
		    document.getElementById("1"+i).src="/home/ovsadmin/italyVoting/xml/images/Row-1-Item-"+i+"-off.jpg";
		  }		 	
		  i=i+1;
		}
	      }
		...
		{
		  if(order !="2"+i) {	    
		    document.getElementById("2"+i).src="/home/ovsadmin/italyVoting/xml/images/Row-2-Item-"+i+"-off.jpg";
		  }		 	
		  i=i+1;
		}
	      }
	   ...
	   if(row==3) {	
		...
		{
		  if(order !="3"+i) {	    
		    document.getElementById("3"+i).src="/home/ovsadmin/italyVoting/xml/images/Row-3-Item-"+i+"-off.jpg";
		  }		 	
		  i=i+1;
		}
	      }
       ...
       function completeVote()
	   {
	     ...
	     var voted3;	     
           ...
           //	var newContent;
           //     newContent="http://odganesanwxp:8080/ItalyVoting/xml/ballots/ballot_"+transactionID+".xml";
           //     window.open(newContent, 'nextWin', 'right=0, top=20,width=825,height=550');                
              ...
              //history.go();
              //document.forms[0].action="/iTalyVotingDemo/actions/scanvoter.do?pageAction=success";
             }
             document.forms[0].submit();
	   }
      </script>
  ...
  <body>
  <form action="http://demo.openvotingsolutions.com/italyVotingDemo/actions/scanvoter.do" >
    ...
    <xsl:for-each select="//row">
      ...
      <tr>
       <xsl:for-each select="child::node()">       	   
		...
		<xsl:attribute name="src">/home/ovsadmin/italyVoting/xml/images/Row-<xsl:value-of select="$row-no"/>-Item-<xsl:value-of select="attribute::node()"/>-selected.jpg</xsl:attribute>		      
