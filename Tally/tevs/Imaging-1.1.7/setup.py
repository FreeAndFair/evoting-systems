#!/usr/bin/env python
#
# Setup script for PILB 1.1.5 and later
#
...
NAME = "PILB"
DESCRIPTION = "Python Imaging Library w Ballot Extensions"
AUTHOR = "Secret Labs AB (PythonWare)", "info@pythonware.com"
AUTHOR = "Ballot extensions in progress by Mitch Trachtenberg"
...
VERSION = find_version("PILB/Image.py")
...
class pil_build_ext(build_ext):
    ...
    def summary_report(self, feature, unsafe_zlib):
        ...
        print "-" * 68
        print "PILB", VERSION, "SETUP SUMMARY"
        print "-" * 68
